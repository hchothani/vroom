...
from utils.detection_examples_utils import split_detection_benchmark
from src.model import YOLOWrapper
from src.twodataset import get_dataset_paths, create_dataloaders, verify_dataset
...
#        test_dataset = Subset(dataset, indices[-test_size:])
    ...
    return split_detection_benchmark(
        ...
        n_classes=6,  # There is only one class: pedestrian
